...
function btnclick(){
	...
	console.log($("input[name=pic]").length);
	if($("input[name=pic]").length + $("label[for=pic]").length < 5){
		$("#re").append(
				$('<input/>').attr({
	    			type: "file",
	    			name: "pic",
...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form action="/postUpdate" method="post" id="frm" enctype="multipart/form-data">
					...
					<div id="re" class="form-group">
						...
						<input type="file" multiple="multiple" name="pic" onclick="btnclick()">
					</div>
